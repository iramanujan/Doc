...
REM "C:\Program Files (x86)\SmartBear\TestComplete 14\x64\Bin\TestComplete.exe" "%ProjectFile%" /run /project:"%ProjectName%" /ExportLog:"%MhtLogFilePath%" /exit /SilentMode
"C:\Program Files (x86)\SmartBear\TestComplete 14\x64\Bin\SessionCreator.exe" RunTest /UserName:Citixsys /Password:Password@123 /ProjectPath:"%ProjectFile%" /project:"%ProjectName%" /ExportLog:"%MhtLogFilePath%" 
REM "C:\Program Files (x86)\SmartBear\TestComplete 14\x64\Bin\TestComplete.exe" "%ProjectFile%" /run /project:"%ProjectName%" /ExportLog:"%MhtLogFilePath%" /exit /SilentMode
...
cd /D "%existingDir%/"
python SendEmail.py %MhtLogFilePath% %LogPath%
TIMEOUT 50
