...
namespace Orange.HRM.TestHarness.Page.Admin.UserManagement.Users
{
    public class SystemUsersPageMap : BasePageElementMap
    {
        ...
        public IWebElement Admin => webDriver.FindElement(By.CssSelector("#menu_admin_viewAdminModule"));
        public IWebElement UserManagement => webDriver.FindElement(By.CssSelector("#menu_admin_UserManagement"));
        public IWebElement User => webDriver.FindElement(By.CssSelector("#menu_admin_viewSystemUsers"));
