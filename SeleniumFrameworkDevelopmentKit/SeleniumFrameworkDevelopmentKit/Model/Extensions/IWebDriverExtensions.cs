...
namespace SeleniumFrameworkDevelopmentKit.Model.Extensions
{
    public static class IWebDriverExtensions
    {
        ...
        public static String GetCurrentWindowHandle(this IWebDriver webDriver)
        {
            return webDriver.CurrentWindowHandle;
        }

        public static int GetCountWindowHandle(this IWebDriver webDriver)
        {
            return webDriver.WindowHandles.Count;
        }

        public static List<String> GetWindowHandles(this IWebDriver webDriver)
        {
